...
int main(int argc, char **argv)
{
    ...
    {
        // ROS_INFO("!!!!!!!!!!!!!!!!!!!!!!! LOOP !!!!!!!!!!!!!!!!!!!!!!!");
        if (offboard_class_node.current_state.mode != "OFFBOARD" && (ros::Time::now() - offboard_class_node.last_request > ros::Duration(5.0))) 
        {
        ...
        {
            if (!offboard_class_node.current_state.armed && (ros::Time::now() - offboard_class_node.last_request > ros::Duration(5.0))) {
